...
public class NeuralNetwork {
	...
	public double[] run(double[] inputs) {
		if(inputs.length != inputLayer.size()) {System.out.println("INCORRECT INPUT DATA TO RUN");}
	...
	public void train(double[] inputs,double[] targets,double learningRate) {
		if(inputs.length != inputLayer.size() || targets.length != outputLayer.size()) {System.out.println("INCORRECT INPUT DATA TO RUN");}
		...
		//System.out.println(error(inputs,targets));
	}
